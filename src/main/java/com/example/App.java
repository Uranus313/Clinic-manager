...
new Patient(STYLESHEET_CASPIAN, STYLESHEET_CASPIAN, STYLESHEET_CASPIAN, STYLESHEET_MODENA, 0, STYLESHEET_CASPIAN).changeInfo(null, primaryStage);
                // new Doctor(0, 0, STYLESHEET_CASPIAN, STYLESHEET_CASPIAN, STYLESHEET_CASPIAN, STYLESHEET_CASPIAN, 0, 0, false, false, STYLESHEET_MODENA, STYLESHEET_CASPIAN).menu(null, primaryStage);
        });
